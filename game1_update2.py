...
class Rock(pygame.sprite.Sprite):
    def __init__(self):
        pygame.sprite.Sprite.__init__(self)
        self.rockwidth = random.randrange(20,60)
        # Random pics
        rand = random.randrange(1, 3)
        if rand == 1:
            self.image = pygame.transform.scale(rock1_img, (self.rockwidth,self.rockwidth*9/8 ))
        else:
            self.image = pygame.transform.scale(rock2_img, (self.rockwidth,self.rockwidth*9/8 ))
    ...
    def update(self):
        ...
        if self.reflect >= 1:
            if self.rect.top < self.reflectpoint:
                self.speed_y = -self.speed_y
        if self.onTheGround():
            self.image = pygame.transform.scale(rock3_img, (self.rockwidth,self.rockwidth*9/8 ))
